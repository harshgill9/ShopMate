        ...
        <div className="fixed bottom-20 right-5 w-80 max-h-[400px] h-80 bg-white dark:bg-gray-900 text-gray-900 dark:text-white shadow-lg rounded-lg flex flex-col z-50">
          ...
          <div className="flex border-t border-gray-300 dark:border-gray-700 p-3">
            <input
              ...
              className="flex-grow bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-white placeholder-gray-500 rounded-l-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500"
              onKeyDown={(e) => e.key === "Enter" && sendMessage()}
            />
            <button
              onClick={sendMessage}
              className="bg-purp hover:bg-purple-600 text-white rounded-r-md px-4 py-2 transition"
            >
              Send
            </button>
          </div>
